  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={phase >= 1 ? { scale: [0, 1.2, 1], rotate: [15, -10, 0] } : { scale: 0, rotate: 15 }}
      ...
      >
        Set a morning reminder so your personalised outfit is ready before you even get out of bed.
      </motion.p>
